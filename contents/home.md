...
<header id="home-header" class="full-width">
   <div class="container">
      <h1><em>Jessy Lauren Smith is a screenwriter</em> from a lot of places.</h1>
   </div>
</header>
...
<h2>Work</h2>
<ul id="items">
{{#query for="type" value="project" sortby="order" sort="asc" block="work-item"}}
</ul>
</div>